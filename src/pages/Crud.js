...
const Crud = () => {
    ...
    useEffect(() => {
        ...
        productService.getProvincia().then((data) => setProducts(data));
    }, []);
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    >
                        ...
                        <Column field="name" header="Nombre" body={nombreBodyTemplate} headerStyle={{ width: "14%", minWidth: "10rem" }}></Column>
